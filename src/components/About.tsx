...
export const About = () => {
  return (
    <section id="about" className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_hsl(203_89%_53%_/_0.05)_0%,_transparent_50%)]" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative aspect-square max-w-lg mx-auto">
              {/* Main Circle */}
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary/20 to-accent/10 animate-pulse-glow" />
              <div className="absolute inset-8 rounded-full bg-card border border-border" />
