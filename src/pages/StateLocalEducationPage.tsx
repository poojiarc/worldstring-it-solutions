...
const supportModels = [
  {
    model: "Project-Based",
    description: "Defined scope implementations with clear deliverables",
  },
  {
    model: "Managed Services",
    description: "Ongoing IT operations and support",
  },
  {
    model: "Consulting",
    description: "Strategic advisory and technology planning",
  },
  {
    model: "Staff Augmentation",
    description: "Skilled resources to supplement your team",
  },
];
                ...
                <div className="space-y-4">
                  {benefits.map((benefit, index) => (
                    ...
                    >
                      ...
                      <span className="text-muted-foreground text-justify leading-relaxed">
                        {benefit}
                      </span>
                    </motion.div>
                  ))}
