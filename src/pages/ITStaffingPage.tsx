...
//     description:
//       "Flexible contract-based professionals for project-specific needs. Scale your team up or down as requirements change.",
//   },
//   {
//     icon: Briefcase,
//     title: "Permanent Staffing",
//     description:
//       "Full-time placement services to build your core team with qualified, vetted IT professionals.",
//   },
//   {
//     icon: Globe,
//     title: "Offshore / Nearshore Staffing",
//     description:
//       "Cost-effective global talent solutions with dedicated offshore and nearshore development teams.",
//   },
//   {
//     icon: Building,
//     title: "Industry-Focused Hiring",
//     description:
//       "Specialized recruitment for healthcare IT, fintech, government, and enterprise sectors.",
//   },
// ];
...
//     description:
//       "We understand your specific needs, skills, and timeline requirements.",
//   },
//   {
//     step: "02",
//     title: "Talent Sourcing",
//     description:
//       "Our recruiters source and screen candidates from our extensive network.",
//   },
//   {
//     step: "03",
//     title: "Interview & Selection",
//     description:
//       "We coordinate interviews and handle all selection processes.",
//   },
//   {
//     step: "04",
//     title: "Onboarding Support",
//     description:
//       "Seamless onboarding with continuous support throughout the engagement.",
//   },
// ];
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {staffingTypes.map((type, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  className="glass-card rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 group text-left"
                >
                  <div className="icon-badge mb-4 group-hover:bg-gradient-to-br group-hover:from-primary group-hover:to-accent">
                    <type.icon className="w-6 h-6 text-primary group-hover:text-white transition-colors" />
                  </div>
