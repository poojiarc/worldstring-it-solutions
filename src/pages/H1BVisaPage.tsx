...
const H1BVisaPage = () => (
  <PageLayout>
    ...
    <div
      ...
      style={{
        backgroundImage: "url('/Images/H1B visa.jpg')",
      }}
    >
          ...
          <div className="container mx-auto px-4 lg:px-8">
            ...
            >
              <div className="flex items-start gap-3 text-muted-foreground">
                ...
                <p className="text-sm">
                  <strong>Disclaimer:</strong> Immigration regulations change frequently. This information is for general guidance only. Please consult with qualified immigration attorneys for specific advice.
                </p>
              </div>
            </motion.div>
