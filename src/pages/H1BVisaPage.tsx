        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-16">
            ...
            {processSteps.map((step, index) => (
              ...
              >
                {/* Step Number */}
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white font-bold mb-4">
                  {step.step}
                </div>

                {/* Title */}
                <h3 className="font-bold text-foreground mb-2 text-lg leading-tight whitespace-nowrap">
                  {step.title}
                </h3>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="glass-card rounded-2xl p-8 max-w-3xl mx-auto text-left"
          >
            <div className="flex items-start gap-3 text-muted-foreground">
