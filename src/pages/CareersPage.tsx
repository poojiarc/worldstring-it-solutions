            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-16">
              ...
              {culturePoints.map((point, index) => (
                <motion.div
                  ...
                  className="text-center bg-white/90 backdrop-blur-md rounded-xl p-6"
                >
                  <point.icon className="w-12 h-12 text-primary mx-auto mb-4" />
            ...
            >
              ...
              <div className="space-y-4 max-w-3xl mx-auto mb-12">
                ...
                {openPositions.map((pos, index) => (
                  <div
                    key={index}
                    className="bg-white/90 backdrop-blur-md border border-border rounded-xl p-4 flex items-center justify-between hover:border-primary/40 transition-colors"
                  >
                    <div>
