...
const culturePoints = [
  { icon: Users, title: "Collaborative Team", description: "Work with talented professionals in a supportive environment" },
  { icon: Rocket, title: "Growth Opportunities", description: "Continuous learning and career advancement programs" },
...
const CareersPage = () => (
  <PageLayout>
    <div className="min-h-screen bg-gradient-to-b from-background via-secondary/20 to-background">
      <PageHero
        title="Careers at WorldString"
        subtitle="Join Our Team"
        description="Build your career with an innovative IT solutions company. We're always looking for talented individuals."
        icon={Briefcase}
      />
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {culturePoints.map((point, index) => (
              ...
              >
                ...
                <p className="text-muted-foreground text-justify sm:text-center leading-relaxed">
                  {point.description}
                </p>
              </motion.div>
            ))}
          ...
          >
            ...
            <div className="space-y-4 max-w-3xl mx-auto mb-12">
              {openPositions.map((pos, index) => (
                <div
                  key={index}
                  className="glass-card rounded-xl p-5 flex items-center justify-between hover:border-primary/30 transition-all"
                >
                  <div>
